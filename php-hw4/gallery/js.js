...
const gallery = {
    settings: {
        ...
        openedImageBack: 'galleryWrapper__back',
        openedImageNext: 'galleryWrapper__next',
        openedImageClass: 'galleryWrapper__image',
        openedImageScreenClass: 'galleryWrapper__screen',
        openedImageCloseBtnClass: 'galleryWrapper__close',
        openedImageCloseBtnSrc: 'images/gallery/close.png',
        errorImageOnLoad: 'images/gallery/notfound.png',
        openedImageBackScr: 'images/gallery/pre.png',
        openedImageNextScr: 'images/gallery/next.png',
    },
    ...
    createScreenContainer() {
        ...
        image.onerror = () => {
            image.src = this.settings.errorImageOnLoad;
        }
